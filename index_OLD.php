...
<body class="multiple-scenes view-control-buttons" onhashchange="myFunction(event)">
    ...
    <div id="pano" style="visibility: hidden;"></div>
    <div id="sceneList" style="visibility: hidden;">
        <div class="sl-wrap">
            <h3>The GUIDE</h3>
            <ul class="scenes">
            ...
            <ul class="scenes">
                ...
                <a href="#about" class="scene" data-id="13-about" style="visibility: hidden;">
            ...
            jQuery(document).find(".info-hotspot-title").each(function() {
                ...
                switch (pagescreen.toLowerCase()) {
                    case "overview":
                        ...
                        break;
                    case "roof":
                        var rooftooltip = '<div class="info-tooltip-text" data-id="#roof-overview"><div class="info-tooltip-text-inner"><p>Confirm you have a Class A roof in good condition in accordance with Building Code requirements to best protect your home from wildfire.</p><span class="info-next-icon-warp"><img src="./assets/images/orange-arrow.png" class="info-hotspot-icon"></span></div></div>';
                        jQuery(this).closest(".info-hotspot-header").parent().append(rooftooltip);
                        break;
                    case "eaves and soffits":
                        var rooftooltip = "<div class='info-tooltip-text' data-id='#eaves-overview'><div class='info-tooltip-text-inner'><p>The under-eave area of your roof is an often-overlooked way fire can enter your home.</p><span class='info-next-icon-warp'><img src='./assets/images/orange-arrow.png' class='info-hotspot-icon'></span></div></div>";
                        jQuery(this).closest(".info-hotspot-header").parent().append(rooftooltip);
                        break;
                    case "gutters":
                        var rooftooltip = "<div class='info-tooltip-text' data-id='#gutters-overview'><div class='info-tooltip-text-inner'><p>Gutters can be a conduit for fire to reach your home.</p > <span class='info-next-icon-warp'><img src='./assets/images/orange-arrow.png' class='info-hotspot-icon'></span> </div > </div > ";
                        jQuery(this).closest(".info-hotspot-header").parent().append(rooftooltip);
                        break;
                    case "vents":
                        var rooftooltip = "<div class='info-tooltip-text' data-id='#attic-overview'><div class='info-tooltip-text-inner'><p>Wind-blown embers are <i style='font-style: italic;'>the principal cause of building ignition</i> and can readily enter attic and crawl space vents.</p><span class='info-next-icon-warp'><img src='./assets/images/orange-arrow.png' class='info-hotspot-icon'></span></div></div>";
                        jQuery(this).closest(".info-hotspot-header").parent().append(rooftooltip);
                        break;
                    case "windows &amp; skylights":
                        ...
                        break;
                    case "siding":
                        var rooftooltip = "<div class='info-tooltip-text' data-id='#siding-overview'><div class='info-tooltip-text-inner'><p>The type of siding you have can either protect your home or make your home more exposed to fire.</p><span class='info-next-icon-warp'><img src='./assets/images/orange-arrow.png' class='info-hotspot-icon'></span></div></div>";
                        jQuery(this).closest(".info-hotspot-header").parent().append(rooftooltip);
                        break;
                    case "fencing":
                        var rooftooltip = "<div class='info-tooltip-text' data-id='#fences-overview'><div class='info-tooltip-text-inner'><p>Your fences can be a major threat to home ignition, and can act like a wick, carrying fire directly to your eaves and siding or even to the home nearest to you.</p><span class='info-next-icon-warp'><img src='./assets/images/orange-arrow.png' class='info-hotspot-icon'></span></div></div>";
                        jQuery(this).closest(".info-hotspot-header").parent().append(rooftooltip);
                        break;
                    case "decks":
                        var rooftooltip = "<div class='info-tooltip-text' data-id='#decks-overview'><div class='info-tooltip-text-inner'><p>Decks can be an unnoticed fire hazard-a burning deck can ignite siding and the house, or break the glass in doors or windows, allowing fire to gain entry.</p><span class='info-next-icon-warp'><img src='./assets/images/orange-arrow.png' class='info-hotspot-icon'></span></div></div>";
                        jQuery(this).closest(".info-hotspot-header").parent().append(rooftooltip);
                        break;
                    case "codes &amp; permits":
                        var rooftooltip = "";
                    ...
                    case "zone 0 (0-5 feet from your home)":
                        var rooftooltip = "<div class='info-tooltip-text' data-id='#landscaping-overview'><div class='info-tooltip-text-inner'><p>The Zone 0 area, the zone within 5 feet of your home, is critical to protecting your home from ember ignition.</p><span class='info-next-icon-warp'><img src='./assets/images/orange-arrow.png' class='info-hotspot-icon'></span></div></div>";
                        jQuery(this).closest(".info-hotspot-header").parent().append(rooftooltip);
                        break;
                    default:
                        break;
